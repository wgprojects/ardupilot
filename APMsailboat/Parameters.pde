...
const AP_Param::Info var_info[] PROGMEM = {
	...
	// @Param: ANEM_ENABLED
    // @DisplayName: Anemometer (wind sensor) enabled
    // @Description: This should be set to 1 if an anemometer is installed
    // @User: Standard
    // @Values: 0:Disabled,1:Enabled
	GSCALAR(anemometer_enabled,        "ANEM_ENABLED",       ANEMOMETER),
	...
	// @Param: SAIL_H
    // @DisplayName: Sail Hauled
    // @Description: The sail servo position where the sail is tighest.
    // @Units: Percent
    // @Range: 0 100
    // @Increment: 1
    // @User: Standard
	GSCALAR(sail_hauled,           "SAIL_H",          SAIL_HAULED),

	// @Param: SAIL_L
    // @DisplayName: Sail Loosed
    // @Description: The sail servo position where the sail is loosest.
    // @Units: Percent
    // @Range: 0 100
    // @Increment: 1
    // @User: Standard
	GSCALAR(sail_loosed,           "SAIL_L",          SAIL_LOOSED),
