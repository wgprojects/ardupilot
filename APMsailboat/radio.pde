...
static void set_control_channels(void)
{
	...
	channel_sail     = RC_Channel::rc_channel(rcmap.sailtrim()-1);
    channel_learn    = RC_Channel::rc_channel(g.learn_channel-1);

	// set rc channel ranges
	channel_steer->set_angle(SERVO_MAX);
	channel_throttle->set_angle(100);
	channel_sail->set_angle(SERVO_MAX);
}
...
static void init_rc_in()
{
	...
	channel_sail->set_default_dead_zone(30);
...
static void init_rc_out()
{
    ...
    RC_Channel::rc_channel(CH_5)->enable_out();
