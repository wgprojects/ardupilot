...
static void Log_Write_Anemometer(void)
{
	//TODO for hacksail - get this working (why does the barometer work and this doesn't???)
    DataFlash.Log_Write_Anemometer(anemometer);
}
